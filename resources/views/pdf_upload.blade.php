...
<head>
    ...
    <title>Upload PDF dengan Dropzone di Laravel</title>
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">Upload PDF dengan Dropzone di Laravel</h1><br>
        ...
        Dropzone.options.pdfUpload = {
            ...
            init: function () {
                ...
                this.on('sending', function(file, xhr, formData) {
                    var data = $('#pdf-upload').serializeArray();  // Ambil data form
